...
function makeInMemoryStore() {
  /** @type {{ [jid: string]: { id: string, lastfetch?: number, subject?: string, name?: string, isChats?: boolean, isContact?: boolean, presence?: import('baileys').PresenceData, metadata?: import('baileys').GroupMetadata } & import('baileys').Chat & import('baileys').Contact }}} */
  let chats = {};
  /** @type {{ [jid: string]: import('baileys').proto.WebMessageInfo[] }} */
  let messages = {};
  /** @type {import('baileys').ConnectionState} */
  ...
  function loadMessage(jid, id = null) {
    ...
    if (jid && !id) {
      id = jid;
      /** @type {(m: import('baileys').proto.WebMessageInfo) => Boolean} */
  ...
  /**
   * @param {string} jid
   * @param {(jid: string) => Promise<import('baileys').GroupMetadata> | null} groupMetadata
   */
